...
display_result(Xt, yt, 332, 'Section_1010309', 'red')
display_result(Xt, y_0311, 333, 'Section_1010311', 'blue')
display_result(Xt, yt, 333, 'Section_1010309', 'red')
#以0310为训练集
clf = svm.SVR(C=9.0, cache_size=200, coef0=0.0, degree=3, epsilon=0.1,
              gamma='auto_deprecated', kernel='rbf', max_iter=-1, shrinking=True,
              tol=0.001, verbose=False)
...
display_result(Xt, yt, 335, 'Section_1010309', 'red')
display_result(Xt, y_0311, 336, 'Section_1010311', 'blue')
display_result(Xt, yt, 336, 'Section_1010309', 'red')
#以0311为训练集
clf = svm.SVR(C=9.0, cache_size=200, coef0=0.0, degree=3, epsilon=0.1,
              gamma='auto_deprecated', kernel='rbf', max_iter=-1, shrinking=True,
              tol=0.001, verbose=False)
...
display_result(Xt, yt, 338, 'Section_1010309', 'red')
display_result(Xt, y_0311, 339, 'Section_1010311', 'blue')
display_result(Xt, yt, 339, 'Section_1010309', 'red')
